            ...
            <table class="min-w-full bg-white rounded shadow-md">
                <thead class="hidden md:table-header-group">
                    <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                        <th wire:click="sortBy('idincidencia')" class="cursor-pointer py-3 px-6 text-left border-r border-white">#</th>
                        <th wire:click="sortBy('usuarioincidencia')" class="cursor-pointer py-3 px-6 text-left border-r border-white">Responsable</th>
                        <th wire:click="sortBy('estadoincidencia_idestadoincidencia')" class="cursor-pointer py-3 px-6 text-left border-r border-white">Estado</th>
                        <th class="py-3 px-6 text-left border-r border-white">Contrato</th>
                        <th wire:click="sortBy('usuarioincidencia')" class="cursor-pointer py-3 px-6 text-left border-r border-white">Autor</th>
                        ...
                        <th wire:click="sortBy('fechaincidencia')" class="cursor-pointer py-3 px-6 text-left border-r border-white">Fecha</th>
                        <th wire:click="sortBy('fecharesolucionincidencia')" class="cursor-pointer py-3 px-6 text-left border-r border-white">Resolución</th>
